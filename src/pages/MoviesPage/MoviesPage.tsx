...
const MoviesPage = () => {
    const [query] = useSearchParams({page: "1", with_genres: "0", filmName: ""});
    const {with_genres, filmName, movies, total_pages} = useAppSelector(state => state.moviesSlice)
    ...
    console.log(with_genres, filmName, movies)
