...
const SearchComponent = () => {
    ...
    const {handleSubmit, register, formState: {errors, isValid}} = useForm<IProps>({
        mode: "all",
    ...
    return (
        <div>
            <form onSubmit={handleSubmit(searchFilms)} className={styles.FormBlock}>
                ...
                <ColorButton disabled={!isValid} variant="contained" size="medium" type={"submit"}>Submit</ColorButton>
                {
